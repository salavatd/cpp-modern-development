...
void TestJsonToXml() {
    ...
    const Json::Document json_doc{Json::Node(std::vector<Json::Node>{
            Json::Node(std::map<std::string, Json::Node>{
                    {"category", Json::Node("food")},
                    {"amount",   Json::Node(2500)}
            }),
            Json::Node(std::map<std::string, Json::Node>{
                    {"category", Json::Node("transport")},
                    {"amount",   Json::Node(1150)}
            }),
            Json::Node(std::map<std::string, Json::Node>{
            ...
            Json::Node(std::map<std::string, Json::Node>{
                    {"category", Json::Node("clothes")},
                    {"amount",   Json::Node(7500)}
            }),
            Json::Node(std::map<std::string, Json::Node>{
                    {"category", Json::Node("travel")},
                    {"amount",   Json::Node(23740)}
            }),
            Json::Node(std::map<std::string, Json::Node>{
                    {"category", Json::Node("sport")},
                    {"amount",   Json::Node(12000)}
            }),
    })};
